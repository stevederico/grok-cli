...
### For Google Gemini API Provider

If using Google's Gemini AI services, configure **one** of the following authentication methods:

1.  **Login with Google (AI model Code Assist):**
    ...
    - <a id="workspace-gca">Users may have to specify a GOOGLE_CLOUD_PROJECT if:</a>
      ...
      1. You have been assigned a license to a current AI model Code Assist standard or enterprise subscription.
      ...
      - If you fall into one of these categories, you must first configure a Google Cloud Project Id to use, [enable the AI model for Cloud API](https://cloud.google.com/gemini/docs/discover/set-up-gemini#enable-api) and [configure access permissions](https://cloud.google.com/gemini/docs/discover/set-up-gemini#grant-iam).
...
3. **Set Ollama as your default provider:**
   ```bash
   export GROK_CLI_PROVIDER="ollama"
   ```
