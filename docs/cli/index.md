...
- **[Authentication](./authentication.md):** A guide to setting up authentication with xAI and Ollama providers.
- **[Commands](./commands.md):** A reference for Grok CLI commands (e.g., `/help`, `/tools`, `/theme`, `/provider`, `/model`).
