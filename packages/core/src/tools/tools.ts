...
import type { ToolCallConfirmationDetails as ImportedToolCallConfirmationDetails } from '../core/types.js';
...
> {
  ...
  ): Promise<ImportedToolCallConfirmationDetails | false>;
...
export interface ToolResult {
   ...
   */
  llmContent: string | Record<string, any>;
...
// Export the enum from core types for tools
export { ToolConfirmationOutcome } from '../core/types.js';

// Types moved to core/types.js for consistency
